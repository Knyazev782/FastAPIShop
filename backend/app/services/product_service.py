...
from ..shcemas.product import ProductResponse, ProductListResponse, ProductCreate
...
class ProductService:
    ...
    def get_product_by_id(self, product_id: int) -> ProductResponse:
        ...
        if not product:
            raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail=f'Product with if {product_id} not found')
